...
function AddProfessor(props) {
    ...
    const handleSearch = () => {
        setShowSearch(true)
        let requestUrl = Url + "SearchProf/" + CurrentName
        fetch(requestUrl)
            .then((res) => {
                if (res.status == 200) {
                    return res.json()
    ...
    const handleRequest = () => {
        let obj = {
            ...
            professorid: CurrentIdProf
        }
        setShowLoading(true)

        let requestUrl = Url + "professorturma"
        ...
        <Row className="d-flex justify-content-center align-items-center text-dark slidein">
            {ShowLoading &&
                <div className="loading-request shadow-lg bg-white d-flex align-items-center justify-content-center flex-column" style={{ width: '50%', height: '450px', position: 'absolute', zIndex: '12', }}>
                    ...
                    <div className="mt-5">
                        Adicionando o professor a Instituicao
                </div>
                </div>
            }
            {ShowSuccess &&
            ...
            <Col lg="7" className="shadow rounded m-3 big-post form-objetivo d-flex flex-column justify-content-center align-items-start">
                <div className="form-input mt-3">
                    <label className="title-ranking mb-5">
                        <b>Busque por um professor</b><br />
                    ...
                    <div className="mt-2 d-flex">
                        ...
                        }} type="text" placeholder="Nickname do professor" />
